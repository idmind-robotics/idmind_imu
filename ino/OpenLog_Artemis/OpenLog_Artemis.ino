...
void beginIMU()
{
  ...
  //  success &= (myICM.writeDMPmems(CPASS_BIAS_Z, 4, &compassBiasOne[0]) == ICM_20948_Stat_Ok);
    ...
    // Set the DMP Output Data Rate for Quat9 to 15Hz.
    success &= (myICM.setDMPODRrate(DMP_ODR_Reg_Quat9, 15) == ICM_20948_Stat_Ok);
    ...
    // Check success
    if( success ){
      SerialPrintln("DMP enabled!");
      online.IMU = true;
    }
    else
    {
      SerialPrintln("Enable DMP failed!");
      online.IMU = false;
    }
  }
}
